...
namespace SUI
{
    public static class Security
    {
        ...
        public static int UserIdFromToken(string Token)
        {
            ...
            catch { throw new UnauthorizedAccessException("sui:You must login to continue"); }
        }
        ...
        public static void VerifyUser(string Token, bool IgnoreTimeout = false)
        {
            ...
            catch (Exception Exception) { throw new UnauthorizedAccessException(Exception.Message); }
        }
